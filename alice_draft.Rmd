...
all_data_2 = 
  ...
  janitor::clean_names() %>% 
  select(geo_join_id, geo_place_name, indicator_id, time_period, homes_with_cockroaches, poverty, public_school_children_5_14_yrs_old_with_asthma, public_school_children_5_14_yrs_old_with_persistent_asthma) 
