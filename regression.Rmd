...
linear_model = 
  lm(public_school_children_5_14_yrs_old_with_asthma ~ homes_with_cockroaches * poverty, data = tidy_asthma) %>%
  broom::tidy()

ggplot(tidy_asthma, aes(x = homes_with_cockroaches, y = public_school_children_5_14_yrs_old_with_asthma, color = poverty)) +
  geom_point() + 
