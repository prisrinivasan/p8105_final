...
fit = lm(public_school_children_5_14_yrs_old_with_asthma ~ homes_with_cockroaches + poverty + geo_join_id, data=test)

fit

test=
  modelr::add_residuals(fit) %>% 
  ggplot(aes(x = geo_join_id, y = resid)) + geom_point()
