...
The _Asthma in NYC Neighborhoods_ chart displays asthma rates in different neighborhoods from 2011-2014. Users can move between different years and watch neighborhood asthma rates change across NYC or press `play` to view these changes.
...
The _Asthma in NYC Boroughs_ chart shows the regional asthma trends from 2011-2014. Moving through different years shows the changes in regional asthma prevalence over time.
