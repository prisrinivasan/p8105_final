...
The toll of asthma on children has drawn attention and resources towards mitigation. While root causes of asthma are still [unknown](https://www.webmd.com/asthma/asthma-triggers#1), common triggers - particularly those associated with allergies - have been isolated. Household pests, including cockroaches and mice, are one of the most [common indoor triggers](https://www.cdc.gov/asthma/triggers_indoor.html). 

The analysis presented here explores the association between childhood asthma and another highly prevalent NYC phenomenon - cockroaches.  
## Data
