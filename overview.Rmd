...
```{r tidying data, message = FALSE, include = FALSE, eval = TRUE}
all_data = 
...
* We then assessed the crude relationship between cockroach presence in the home (exposure) and childhood asthma (outcome).
