...
We were inspired to work on this project given our collective interest in environmental health and from classes we took during the CORE semester of the Master of Public Health program here at Columbia University's Mailman School of Public Health. In addition, we were inspired by the fact that having asthma is more than just a chronic illness. It is also a social justice issue. The following sites were the basis of our inspiration:
