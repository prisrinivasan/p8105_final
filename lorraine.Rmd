...
Merge the asthma dataframe and the fixed parsing failures dataframe together
...
Tidying the dataframe to be used for analysis and plots
...
asthma_data_tidy = 
  ...
  select(name, geo_entity_id, year, data_value) %>%
  drop_na(year)  %>%
